      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Public Username',
                style: TextStyle(color: Colors.black, fontSize: 24, fontWeight: FontWeight.bold)),
            const SizedBox(
              height: 12,
            ),
            const Text('This will be your Public handle.',
            ...
            Container(
              ...
              child: Row(
                ...
                children: const [
                  SizedBox(width: 20),
                  Text('@', style: TextStyle(color: Color(0xFF1337F6), fontSize: 20, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
            const SizedBox(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          navigator.push(MaterialPageRoute(builder: (context) => const EmailPage()));
                        },

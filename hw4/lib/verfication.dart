        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Send Again',
                style: TextStyle(color: Color(0xFF1337F6), fontWeight: FontWeight.bold, fontSize: 14)),
            const SizedBox(
              height: 8,
            ),
            Container(
              ...
              child: Row(
                ...
                children: const [
                  SizedBox(width: 20),
                  Text('XXX XXX', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
            const SizedBox(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          navigator.push(MaterialPageRoute(builder: (context) => const AssetChoicePage()));
                        },
